const baskets = [
  {
    ...
    price: "$65",
    image: "/images/chr1.jpg",
  },
  {
    id: 2,
    name: "Chocolate Love Basket",
    price: "$80",
    image: "/images/chr2.jpg",
  },
  {
    id: 3,
    name: "Luxury Rose Basket",
    price: "$120",
    image: "/images/chr3.jpg",
  },
  {
    id: 4,
    name: "Couple Surprise Basket",
    price: "$95",
    image: "/images/chr4.jpg",
  },
  {
    id: 5,
    name: "Teddy & Candy Basket",
    price: "$70",
    image: "/images/chr5.jpg",
  },
];
      ...
      <div className="min-h-[100dvh] bg-white pt-[150px]">
        ...
        <section className="px-6 py-14 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold text-[#245236]">
            Christmas Basket Gallery
          </h1>

          <p className="max-w-2xl mx-auto mt-5 text-gray-600 text-base md:text-lg">
            Explore our beautiful collection of handcrafted christmas baskets
...
export default ChristmasBaskets;

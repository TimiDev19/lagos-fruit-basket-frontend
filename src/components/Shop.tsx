                ...
                {products.map((product) => (
                    <div key={product._id} className=" max-w-[40vw] lg:max-w-[20vw]">
                        ...
                        <div className=" w-full flex items-center justify-between">
                            ...
                            <div onClick={() => handleAddToCart(product)} className=" cursor-pointer h-[24px] lg:h-[42px] w-[24px] lg:w-[42px] bg-[#245236] rounded-full flex items-center justify-center">
